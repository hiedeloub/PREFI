...
public static void fprecord() {
        ...
        System.out.println("");    
        System.out.println("||------------------------||");
        System.out.println("     FOSTER PARENT      ");  
        System.out.println("||------------------------||");
        System.out.println("");
    ...
    private void updatefparent(){
        ...
        String qry = "UPDATE tbl_fosterparent SET fname = ?,lname = ?, address = ?,contact = ? WHERE FPID = ?";
      ...
      private void deletefparent() {
          ...
          while(conf.getSingleValue("SELECT FPID FROM tbl_fosterparent WHERE FPID = ?", id) == 0){
             System.out. print("Selected ID doesn't exist!");
             System.out. print("Select FP ID Again: ");
             id = sc.nextInt();
}
          
          String qry = "DELETE FROM tbl_fosterparent WHERE FPID = ?";
